# ExitAnt Infinite-Buy — Hyperliquid
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/ExitAnt-dev/infinite-hl-5)

Or open this link in your browser:

```
https://render.com/deploy?repo=https://github.com/ExitAnt-dev/infinite-hl-5
```
...
- **Prebuilt image.** The worker pulls `docker.io/exitant/exitant-infinite-hl:5` from Docker Hub. The image ships
